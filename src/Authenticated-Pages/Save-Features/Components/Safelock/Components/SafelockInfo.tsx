            ...
            >
              <div>
                ...
                <div className="legends">
                  <h2>What is Safelock?</h2>
                  <p>
                    Safelock allows you to set money aside for fixed period of
                    time without having access to it until maturity. It's like
                    having your own custom fixed deposit.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="legends">
                  ...
                  <p>
                    Set the desired duration of time to lock funds. You can lock
                    for as little as 10 days or as much as 365 days.
                  </p>
                </div>
              </div>
              <div>
